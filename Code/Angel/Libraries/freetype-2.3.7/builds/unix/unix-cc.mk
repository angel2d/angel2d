...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -O -g -isysroot /Developer/SDKs/MacOSX10.5.sdk -arch i386 -arch ppc -DFT_CONFIG_OPTION_SYSTEM_ZLIB -DDARWIN_NO_CARBON -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS := -isysroot /Developer/SDKs/MacOSX10.5.sdk -arch i386 -arch ppc -lz
