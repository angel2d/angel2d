...
begin
  case errcode of
    ...
    FMOD_ERR_SUBSOUND_CANTMOVE:      FMOD_ErrorString := 'Shared subsounds cannot be replaced or moved from their parent stream, such as when the parent stream is an FSB file.';
