...
const
    ...
    FMOD_INIT_PS3_PREFERDTS            = $00800000;   (* PS3 only - Prefer DTS over Dolby Digital if both are supported. Note: 8 and 6 channel LPCM is always preferred over both DTS and Dolby Digital. *)
    FMOD_INIT_PS3_FORCE2CHLPCM         = $01000000;   (* PS3 only - Force PS3 system output mode to 2 channel LPCM.
