...
' ============================================================================================ '
' FMOD Ex - Visual Basic Module.    Copyright (c), Firelight Technologies Pty, Ltd. 2004-2008. '
'                                                                                              '
'                                                                                              '
' ============================================================================================ '
...
Public Const FMOD_VERSION As Long = &H41600
...
Public Enum FMOD_INITFLAGS
    ...
    FMOD_INIT_SOFTWARE_REVERB_ON_FX = &H40           ' All platforms - Apply reverb connections to the channel DSP head (after the DSP effects) instead of directly to the sound source.
    ...
    FMOD_INIT_PS3_PREFERDTS = &H800000               ' PS3 only - Prefer DTS over Dolby Digital if both are supported. Note: 8 and 6 channel LPCM is always preferred over both DTS and Dolby Digital.
    FMOD_INIT_PS3_FORCE2CHLPCM = &H1000000           ' PS3 only - Force PS3 system output mode to 2 channel LPCM.
